    ...
    <div className="border-l flex flex-col h-full border-stroke dark:border-strokedark">
      ...
      <div className="mx-auto my-8">
        <img
          ...
          alt="Profile"
          className="w-64 h-44 rounded-lg object-cover object-center"
        />
      </div>
      ...
      <div className="px-6 flex flex-row space-x-2">
        ...
        <button className="border border-stroke dark:border-strokedark p-2 rounded-md flex items-center justify-center">
